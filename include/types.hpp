...
enum class LBool { TRUE, FALSE, UNDEF };
...
inline bool isUndefined(LBool x) { return x == LBool::UNDEF; }

// for strong-typing between Var, Lit and other integers
template <typename Tag> struct StrongInt {
...
inline Lit operator~(Lit x) { return Lit{-x.val}; }
...
inline bool ifNeg(Lit x) { return x.val < 0; }
} // namespace peregrine::core
